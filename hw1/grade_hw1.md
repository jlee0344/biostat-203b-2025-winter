...
- Q6 (10/10)
   ...
   `"/Users/julielee/Desktop/203b-hw/hw1/screenshot.png"` does not work on my laptop. But it is fine because you submitted the screenshot. You should have put `eval=FALSE`. `0.0`
...
-   Are the materials (files and instructions) submitted to the `main` branch sufficient for reproducing all the results? Just click the `Render` button will produce the final `html`? 
    ...
    Q6. Again, `"/Users/julielee/Desktop/203b-hw/hw1/screenshot.png"` stops rendering on my laptop. `-2.0`
