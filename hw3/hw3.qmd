...
patient_summary_text <- str_squish(paste0(
  "Patient ", patient_record$subject_id, ", ",
...
patient_timeline <- ggplot() +
  geom_segment(data = transfer_details, 
               ...
               alpha = 0.8) +  # Keeps Care Unit legend
  ...
  scale_linewidth_continuous(guide = "none") +  # Removes linewidth legend
...
ggplotmimic_icu_cohort, aes(x = age_group, y = los, fill = age_group)) +
  geom_boxplot() +
