...
```{r}
#Counting number of unique 'subject_id' 
...
multiple_stays <- icu_stays_per_subject %>%
  filter(num_stays > 1) %>%
  summarise(subjects_with_multiple_stays = n())

print(multiple_stays)
```

**(2.2) Solution ** 
The number of unique subject_id there are in the (icustays_tble) tibble is 
