...
### Completeness, correctness and efficiency of solution: 210/200
...
- Q2 (110/100)
    ...
    -  Great job! Easy to operate and flexible. `+5.0`

    -  Your app can remove extreme values only for numerical variables. `+5.0`. 
    
    -  For demographic summary,  labeling and coloring look redundant because there are in the x-axis. `+0.0`
