...
- Nice pre-processing steps. `+5.0`

- Nice report of the results. `+5.0`

- The model stacking is not performed. `-10.0`

- XGBoost (as well as logistic regression) provides variable importance measures similar to those from random forests. `-5.0`
